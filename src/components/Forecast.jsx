		...
		<div>
			...
			<div className=' flex flex-col w-full   items-center justify-center text-white '>
				{data.list.splice(0, 7).map((item, idx) => (
					<div
						key={idx}
						className=' flex flex-row max-[934px]:flex-col max-[934px]:justify-center justify-between text-center items-center border-[1px] py-4 px-8 w-full m-2 border-[red] rounded-[40px] h-[200px] '
					><p className='text-[white] font-light text-sm'>{forecastDays[idx]}</p>
						...
						<img
							...
							className=' my-1'
						/>       
            <p className='text-[white] font-blod text-sm'>{item.weather[0].description}</p>
