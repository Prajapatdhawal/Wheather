			...
			<nav className='fixed inset-x-0 bg-[#000a18] items-center justify-between py-6 px-16 max-[750px]:px-10 max-[300px]:px-6 z-[200] flex'>
				...
				<div className='hidden max-[750px]:flex justify-start items-center b'>
					...
					<div
						className={`${
							!toggle ? "hidden" : "block"
						} p-6 absolute top-20 left-0 bottom-0 h-screen min-w-[250px] sidebar bg-[black]  backdrop-filter backdrop-blur-xl  bg-opacity-[0.5]  z-50`}
					></div>
				</div>
				...
				<div className=' flex items-center space-x-8  max-[750px]:space-x-0'>
					<span className='flex flex-row w-1/4 items-center justify-center space-x-2 max-[750px]:hidden'>
						<button name='metric' className=' text-xl text-black font-light'>
							&deg;C
						</button>
						<p className='text-black text-xl mx-1'> |</p>
						<button name='imperial' className=' text-xl text-black font-light'>
							&deg;F
						</button>
					</span>
